...
class AppTheme {
  ...
  // Color Specifications based on Soft Technical Palette
  static const Color primaryLight =
      Color(0xFF2E7D32); // Deep green for active states
  ...
  static const Color surfaceLight =
      Color(0xFFFAFAFA); // Consistent with background
  static const Color errorLight = Color(0xFFF44336); // Standard red for errors
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onBackgroundLight =
      Color(0xFF212121); // Dark gray for text
  static const Color onSurfaceLight = Color(0xFF212121);
  static const Color onErrorLight = Color(0xFFFFFFFF);

  // Additional semantic colors
  static const Color accentLight =
      Color(0xFFFF6F00); // Warm orange for attention
  static const Color successLight =
      Color(0xFF4CAF50); // Clear green for success
  static const Color warningLight = Color(0xFFFF9800); // Amber for warnings
  static const Color disabledLight =
      Color(0xFF9E9E9E); // Neutral gray for disabled
  static const Color dividerLight =
      Color(0xFFE0E0E0); // Subtle gray for separation
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    sliderTheme: SliderThemeData(
      ...
      disabledActiveTrackColor: disabledLight,
      disabledInactiveTrackColor: disabledLight.withValues(alpha: 0.3),
      disabledThumbColor: disabledLight,
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    sliderTheme: SliderThemeData(
      ...
      disabledActiveTrackColor: disabledDark,
      disabledInactiveTrackColor: disabledDark.withValues(alpha: 0.3),
      disabledThumbColor: disabledDark,
    ),
    tabBarTheme: const TabBarTheme(
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles - Roboto headings
      ...
      // Headline styles - Roboto headings
  ...
  /// Get Roboto Mono for data display
  ...
  static Color getSemanticColor(String colorName, {required bool isLight}) {
